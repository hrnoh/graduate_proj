			...
			<div class="col-xs-12">
				<form class="form-horizontal">
					<div class="form-group">
						...
						<div class="col-xs-10">
							<p class="form-control-static">${doorlockVO.mac }</p>
						</div>
					</div>
					<div class="form-group">
						<label class="col-xs-2 control-label">Location</label>
						<div class="col-xs-10">
							<p class="form-control-static">${doorlockVO.location }</p>
						</div>
					</div>
					<div class="form-group">
						<label class="col-xs-2 control-label">Level</label>
						<div class="col-xs-10">
							<p class="form-control-static">${doorlockVO.level }</p>
						</div>
					</div>
				</form>
			</div>
					...
					<div class="panel-body">
						<table class="table table-fixed">
							<thead class="col-xs-12">
								<tr class="col-xs-12">
									<th class="col-xs-2">부서</th>
									<th class="col-xs-1 text-center">직급</th>
									<th class="col-xs-2 text-center">이름</th>
									<th class="col-xs-5 text-center">시간</th>
									<th class="col-xs-2 text-center">결과</th>
								</tr>
							</thead>
							<tbody class="col-xs-12">
								<c:forEach var="log" items="${list }">
									<tr class="col-xs-12">
										<td class="col-xs-2">${log.deptName }</td>
